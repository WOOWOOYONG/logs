...
![Web Worker 在背景執行緒處理運算的示意圖](../../assets/images/notes/34/34-0.png)
...
![Partytown 架構示意圖](../../assets/images/notes/34/34-3.png)
...
**使用 Partytown 之前**
![使用 Partytown 之前的 PageSpeed 測試結果](../../assets/images/notes/34/34-1.png)

**使用 Partytown 之後**
![使用 Partytown 之後的 PageSpeed 測試結果](../../assets/images/notes/34/34-2.png)

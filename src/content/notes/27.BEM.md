...
![BEM 卡片元件範例](https://i.imgur.com/av1o8Fq.png)

## 命名範例

### \*一般的命名方式

![一般的 class 命名方式](https://i.imgur.com/P4cqWUv.png)

### \*使用 BEM 命名

![使用 BEM 的命名方式](https://i.imgur.com/GLtlQuu.png)
...
![BEM 搭配 SCSS 的寫法範例](https://i.imgur.com/MBSQwt2.png)
